...
<div id="calendar_wrap" align="center">
	<table id="wp-calendar">
		<caption>
<?php
			echo $textmonth." ".$year."<br />".$smon_hijri 
?>
		</caption>
<!--
<tr>
...
if($i == 1 || $dayofweek == 0):
		echo " <tr style=\"background-color: $defaultbgcolor; height: 24px;\" >\n";
if($span1 > 0 && $i == 1)
	echo " <td align=\"left\" style=\"background-color:#999;\"
...
<?php ?>
<font color="<?php echo $fontcolor; ?>" face="<?php echo $fontfamily; ?>" size="1">
...
if($i == $days):
	if($span2 > 0)
		echo " <td align=\"left\" style=\"background-color: #ddd;\"
