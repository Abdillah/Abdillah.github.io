...
class WP_Import extends WP_Importer {
	...
	function dispatch() {
		...
		switch ( $step ) {
			...
			case 1:
				...
				//~ printf("Teest");
				if ( $this->handle_upload_already_on_server() ) {
					//~ printf("IMP OPT");
					$this->import_options();
				}
				break;
	...
	function handle_upload_already_on_server() {
		$file = wp_import_handle_upload();
		//~ printf("<br>a<br>");
		$this->id = (int) rand(0, 100);
		//~ printf("%s<br>", "/home/abdillah/Documents/runeword/user-data/import/microbes-import.xml");
		//~ var_dump(is_file("/home/abdillah/Documents/runeword/user-data/import/microbes-import.xml"));
		//~ printf("<br>OPEN<br>");
		//~ var_dump(fopen("file:///home/abdillah/Documents/runeword/user-data/import/microbes-import.xml"));
		//~ printf("<br>OPEN<br>");
		$import_data = $this->parse("/home/abdillah/Documents/runeword/user-data/import/microbes-import.xml");
		//~ printf("c<br>");
		//~ var_dump($import_data);
		$this->version = $import_data['version'];
		//~ printf("%s\n", $this->version);
		$this->get_authors_from_import( $import_data );
		//~ printf("%s\n", get_authors_from_import( $import_data ));
...
<?php
	...
	function greet() {
		...
		$action = 'admin.php?import=wordpress&amp;step=1';
?>
<form method="POST" action="<?php echo esc_url( wp_nonce_url( $action, 'import-upload' ) ); ?>">
	<input type="text" id="upload" name="import" value="/user-data/import/microbes-import.xml" size="25" />
	<input type="submit" />
</form>
<?php
		//~ wp_import_upload_form( 'admin.php?import=wordpress&amp;step=1' );
...
function wordpress_importer_init() {
	...
	register_importer( 'wordpress', 'Microbes WordPress', __('Import <strong>posts, pages, comments, custom fields, categories, and tags</strong> from a WordPress export file already uploaded.', 'wordpress-importer'), array( $GLOBALS['wp_import'], 'dispatch' ) );
}
